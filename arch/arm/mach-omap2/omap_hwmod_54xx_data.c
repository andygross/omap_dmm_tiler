...
static struct omap_hwmod_class_sysconfig omap54xx_debugss_sysc = {
	.rev_offs	= 0x0000,
	.sysc_offs	= 0x0010,
	.syss_offs	= 0x0014,
...
static struct omap_hwmod_class omap54xx_debugss_hwmod_class = {
	.name	= "debugss",
	.sysc	= &omap54xx_debugss_sysc,
};

/* debugss */
static struct omap_hwmod_irq_info omap54xx_debugss_irqs[] = {
	{ .name = "ct_uart_tx", .irq = 89 + OMAP54XX_IRQ_GIC_START },
	{ .name = "ct_uart_rx", .irq = 90 + OMAP54XX_IRQ_GIC_START },
	{ .irq = -1 }
};

static struct omap_hwmod_dma_info omap54xx_debugss_sdma_reqs[] = {
	{ .dma_req = 6 + OMAP54XX_DMA_REQ_START },
	{ .dma_req = -1 }
};

static struct omap_hwmod omap54xx_debugss_hwmod = {
	.name		= "debugss",
	.class		= &omap54xx_debugss_hwmod_class,
	.clkdm_name	= "emu_clkdm",
	.mpu_irqs	= omap54xx_debugss_irqs,
	.sdma_reqs	= omap54xx_debugss_sdma_reqs,
	.main_clk	= "sys_clkin",
	.prcm = {
		.omap4 = {
			.clkctrl_offs = OMAP54XX_CM_EMU_DEBUGSS_CLKCTRL_OFFSET,
		},
	},
};
...
static struct omap_hwmod_class omap54xx_prcm_hwmod_class = {
	.name	= "prcm",
};

/* prcm_mpu */
static struct omap_hwmod omap54xx_prcm_mpu_hwmod = {
	.name		= "prcm_mpu",
	.class		= &omap54xx_prcm_hwmod_class,
	.clkdm_name	= "wkupaon_clkdm",
};
...
static struct omap_hwmod omap54xx_sl2if_hwmod = {
	...
	.prcm = {
		.omap4 = {
			...
			.context_offs = OMAP54XX_RM_IVA_SL2_CONTEXT_OFFSET,
			.modulemode   = MODULEMODE_HWCTRL,
		},
	},
};
...
/* slimbus2 */
static struct omap_hwmod_irq_info omap54xx_slimbus2_irqs[] = {
	{ .irq = 98 + OMAP54XX_IRQ_GIC_START },
	{ .irq = -1 }
};

static struct omap_hwmod_dma_info omap54xx_slimbus2_sdma_reqs[] = {
	{ .name = "tx0", .dma_req = 92 + OMAP54XX_DMA_REQ_START },
	{ .name = "tx1", .dma_req = 93 + OMAP54XX_DMA_REQ_START },
	{ .name = "tx2", .dma_req = 94 + OMAP54XX_DMA_REQ_START },
	{ .name = "tx3", .dma_req = 95 + OMAP54XX_DMA_REQ_START },
	{ .name = "rx0", .dma_req = 96 + OMAP54XX_DMA_REQ_START },
	{ .name = "rx1", .dma_req = 97 + OMAP54XX_DMA_REQ_START },
	{ .name = "rx2", .dma_req = 98 + OMAP54XX_DMA_REQ_START },
	{ .name = "rx3", .dma_req = 99 + OMAP54XX_DMA_REQ_START },
	{ .dma_req = -1 }
};
...
static struct omap_hwmod omap54xx_slimbus2_hwmod = {
	.name		= "slimbus2",
	.class		= &omap54xx_slimbus_hwmod_class,
	.clkdm_name	= "l4per_clkdm",
	.mpu_irqs	= omap54xx_slimbus2_irqs,
	.sdma_reqs	= omap54xx_slimbus2_sdma_reqs,
	.main_clk	= "l4_div_ck",
	.prcm = {
		.omap4 = {
			.clkctrl_offs = OMAP54XX_CM_L4PER_SLIMBUS2_CLKCTRL_OFFSET,
			.context_offs = OMAP54XX_RM_L4PER_SLIMBUS2_CONTEXT_OFFSET,
			.modulemode   = MODULEMODE_SWCTRL,
		},
	},
...
/* debugss -> l3_main_2 */
static struct omap_hwmod_ocp_if omap54xx_debugss__l3_main_2 = {
	.master		= &omap54xx_debugss_hwmod,
	.slave		= &omap54xx_l3_main_2_hwmod,
	.clk		= "l3_div_ck",
	.user		= OCP_USER_MPU | OCP_USER_SDMA,
};
...
/* l3_instr -> debugss */
static struct omap_hwmod_ocp_if omap54xx_l3_instr__debugss = {
	.master		= &omap54xx_l3_instr_hwmod,
	.slave		= &omap54xx_debugss_hwmod,
	.clk		= "l3_div_ck",
	.user		= OCP_USER_MPU | OCP_USER_SDMA,
};

static struct omap_hwmod_addr_space omap54xx_debugss_addrs[] = {
	{
		.name		= "drm",
		.pa_start	= 0x54160000,
		.pa_end		= 0x541607ff,
...
/* l3_main_3 -> debugss */
static struct omap_hwmod_ocp_if omap54xx_l3_main_3__debugss = {
	.master		= &omap54xx_l3_main_3_hwmod,
	.slave		= &omap54xx_debugss_hwmod,
	.clk		= "l3_div_ck",
	.addr		= omap54xx_debugss_addrs,
	.user		= OCP_USER_MPU,
};
...
static struct omap_hwmod_addr_space omap54xx_mpu_addrs[] = {
	{
		.name		= "intc_mpu_distributor",
		.pa_start	= 0x48211000,
		.pa_end		= 0x48211fff,
	},
	{
		.name		= "intc_mpu_phys_cpu_if",
		.pa_start	= 0x48212000,
		.pa_end		= 0x48213fff,
	},
	{
		.name		= "intc_mpu_virt_cpu_if_hyp",
		.pa_start	= 0x48214000,
		.pa_end		= 0x482141ff,
	},
	{
		.name		= "intc_mpu_virt_cpu_if_vm",
		.pa_start	= 0x48216000,
		.pa_end		= 0x48217fff,
	},
	{
		.name		= "prcm_mpu_ocp_socket",
		.pa_start	= 0x48243000,
		.pa_end		= 0x48243003,
	},
	{
		.name		= "prcm_mpu_device",
		.pa_start	= 0x48243200,
		.pa_end		= 0x4824321f,
	},
	{
		.name		= "prcm_mpu_prm_c0",
		.pa_start	= 0x48243400,
		.pa_end		= 0x4824343f,
	},
	{
...
static struct omap_hwmod_ocp_if omap54xx_mpu_private__prcm_mpu = {
	.master		= &omap54xx_mpu_private_hwmod,
	.slave		= &omap54xx_prcm_mpu_hwmod,
	.clk		= "l3_div_ck",
	.user		= OCP_USER_MPU | OCP_USER_SDMA,
};
...
static struct omap_hwmod_addr_space omap54xx_slimbus2_addrs[] = {
	{
		.pa_start	= 0x48076000,
		.pa_end		= 0x480763ff,
		.flags		= ADDR_TYPE_RT
...
/* l4_per -> slimbus2 */
static struct omap_hwmod_ocp_if omap54xx_l4_per__slimbus2 = {
	.master		= &omap54xx_l4_per_hwmod,
	.slave		= &omap54xx_slimbus2_hwmod,
	.clk		= "l4_div_ck",
	.addr		= omap54xx_slimbus2_addrs,
	.user		= OCP_USER_MPU | OCP_USER_SDMA,
};
